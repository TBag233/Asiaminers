...
#	Author:	Rat's
#	Dscription: Asiaminers Socat一键脚本
#	Version: 1.1
#	Blog: tbag
# ====================================================
...
config_socat(){
    ...
    read -p "提示请输入本地端口:" port1
    read -p "提示请输入远程端口:" port2
    read -p "提示请输入远程IP:" socatip
}
